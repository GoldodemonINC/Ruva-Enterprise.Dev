...
impl CodeGen {
    ...
    pub fn generate_rust(&mut self, program: &Program) -> String {
        ...
        self.writeln("");
        self.writeln("type string = String;");
        self.writeln("");
    ...
    fn gen_struct(&mut self, s: &StructDef) {
        ...
        let mut derives = vec!["Clone".to_string(), "Debug".to_string()];
        derives.extend(s.derives.iter().cloned());
        derives.dedup();
    ...
    fn gen_enum(&mut self, e: &EnumDef) {
        ...
        self.writeln("#[derive(PartialEq, Clone, Debug)]");
